/*!mm={version:"",license:"MIT",author:"uupaa.js@gmail.com",date:"2012-11-08T15:13:30",tool:"google",target:"",cutoff:"assert/debug/spec/interface/ie/gecko/opera"}*/
//{@es
...
function _defineLibraryAPIs(mix) {
    ...
    mm = mix(HashFactory, {             // mm(obj:Object/Hash):Hash
        ...
        deny:       mm_deny,            // mm.deny(name:String, mix:Mix, judge:Function/Boolean/TypeNameString)
        allow:      mm_allow,           // mm.allow(name:String, mix:Mix, judge:Function/Boolean/TypeNameString)
        perf:       mm_perf,            // mm.perf():Object - calc performance data
...
//[ES]  bind:       Function_bind,      // fn#bind():Function
        help:   mix(Function_help, {    // fn#help(that:Object = null):String
            add:    Function_help_add,  // fn#help.add(url:URLString, word:String/StringArray/RegExp)
...
//{@debug
    mm.allow("data", data, "Object/Function/Array/Hash");
    mm.allow("fn",   fn,   "Function");
//}@debug
...
function mm_keys(data) { // @arg Object/Function/Array/Hash/Style/Node/Global:
                         ...
                         // @desc: enumerate keys
//{@debug
    mm.allow("data", data, "Object/Function/Array/Hash/Style/Node/Global");
//}@debug
...
function mm_uid(group) { // @arg String(= ""): uid group name.
                         ...
                         // @desc: get unique id
//{@debug
    mm.allow("group", group, "String/undefined");
//}@debug
...
function mm_copy(mix,    // @arg Mix: source object
                 ...
                 hook) { // @arg Object(= null): handle the unknown object
                         ...
                         //        do not look prototype chain.
//{@debug
    mm.allow("depth", depth, "Integer/undefined");
    mm.allow("hook",  hook,  "Function/undefined");
//}@debug
...
//{@debug
    mm.allow("from", from, "String");
    mm.allow("to",   to,   "String");
...
function mm_dump(mix,     // @arg Mix: data
                 ...
                 depth) { // @arg Integer(= 5): max depth, 0 to 100
                          ...
                          // @desc: Dump Object
//{@debug
    mm.allow("spaces", spaces, "Integer/undefined");
    mm.allow("depth",  depth,  "Integer/undefined");
//}@debug
...
function mm_pair(key,     // @arg Object/Integer/String: key
                 value) { // @arg Mix: value
                          ...
                          // @desc: make pair
//{@debug
    mm.allow("key", key, "Object/Integer/String");
//}@debug
...
//{@debug
    mm.allow("data",  data,  "Object/Function/Array/Hash");
    mm.allow("glue",  glue,  "String/undefined");
    mm.allow("joint", joint, "String/undefined");
//}@debug
...
//{@debug
    mm.allow("data", data, "Object/Function/Array/Hash");
    mm.allow("only", only, "String/undefined");
//}@debug
...
function mm_logg(label,  // @arg String/Function: label (group name)
                 mode) { // @arg Integer(= 0x0): 0x4 is perf mode
                         ...
                         // @desc: log group
//{@debug
    mm.allow("label", label, "String/Function");
    mm.allow("mode",  mode,  "Integer/undefined");
//}@debug
...
//{@debug
    mm.allow("date", date, "Date/String");
//}@debug
...
//{@debug
    mm.allow("diffDate", diffDate, "Date/Integer");
//}@debug
...
function Date_format(format) { // @arg String(= "I"): format("Y-M-D h:m:s.ms")
                               ...
                               // @desc: format date
//{@debug
    mm.allow("format", format, "String/undefined");
//}@debug
...
function Array_range(begin,          // @arg Integer: begin number
                     ...
                     filterOtStep) { // @arg Function/Integer(= 1): filter or skip number
                                     // @ret Array: [begne, ... end]
...
//{@debug
    mm.allow("begin",        begin,        "Integer");
    mm.allow("end",          end,          "Integer");
    mm.allow("filterOtStep", filterOtStep, "Function/Integer/undefined");
//}@debug
...
//{@debug
    mm.allow("code",       code,       "String/undefined");
    mm.allow("startIndex", startIndex, "Integer/undefined");
    mm.allow("endIndex",   endIndex,   "Integer/undefined");
//}@debug
...
//{@debug
    mm.allow("index", index, "Integer/undefined");
//}@debug
...
//{@debug
    mm.allow("lastIndex", lastIndex, "Integer/undefined");
//}@debug
...
function Array_clamp(low,    // @arg Number: low numeric value
                     high) { // @arg Number: high numeric value
                             ...
                             // @help: Array#clamp
//{@debug
    mm.allow("low",  low,  "Number");
    mm.allow("high", high, "Number");
//}@debug
...
//{@debug
    mm.allow("desc", desc, "Boolean/undefined");
//}@debug
...
function Array_average(median) { // @arg Boolean(= false): true is median `` ソートしたサンプルの中央の値を採用します
                                 ...
                                 // @help: Array#average
//{@debug
    mm.allow("median", median, "Boolean/undefined");
//}@debug
...
function Array_and(compare) { // @arg Array: compare array
                              ...
                              // @help: Array#and
//{@debug
    mm.allow("compare", compare, "Array");
//}@debug
...
function Array_fill(value, // @arg Primitive/Object/Array/Date(= undefined): fill value
                    ...
                    to) {  // @arg Integer(= this.length): fill to index
                           ...
                           // @help: Array#fill
//{@debug
    mm.allow("value", value, "Primitive/Array/Date");
    mm.allow("from",  from,  "Integer/undefined");
    mm.allow("to",    to,    "Integer/undefined");
//}@debug
...
//{@debug
    mm.allow("find",    find,    "String");
    mm.allow("anagram", anagram, "Boolean/undefined");
//}@debug
...
//{@debug
    mm.allow("maxLength", maxLength, "Integer");
    mm.allow("omit",      omit,      "String/undefined");
//}@debug
...
//{@debug
    mm.allow("end",          end,          "Integer");
    mm.allow("filterOrStep", filterOrStep, "Function/Integer/undefined");
//}@debug
...
//{@debug
    mm.allow("digits", digits, "Integer/undefined");
    mm.allow("radix",  radix,  "Integer/undefined");
...
//{@debug
    mm.allow("value", value, "Integer/undefined");
//}@debug
...
//{@debug
    mm.allow("fn_that", fn_that, "Function/Array");
...
//{@debug
    mm.allow("range", range, "Integer/undefined");
...
function Function_help_add(url,    // @arg URLString: help url string
                           word) { // @arg String/StringArray/RegExp: keywords or pattern
                                   // @desc: add help chain
//{@debug
    mm.allow("url",  url,  "String");
    mm.allow("word", word, "String/Array/RegExp");
//}@debug
...
//{@debug
    mm.allow("defaultName", defaultName, "String/undefined");
//}@debug
...
//{@debug
    mm.allow("command", command, "String/undefined");
//}@debug
...
//{@debug
    mm.allow("waits", waits, "Integer");
    mm.allow("tick",  tick,  "Function/undefined");
...
//{@debug
    mm.allow("missables", missables, "Integer");
...
function Array_test(label, // @arg String(= ""): label
                    arg) { // @arg Mix(= undefined): test arg
                           ...
                           // @desc: unit test
//{@debug
    mm.allow("label", label, "String/undefined");
//}@debug
...
function String_stream(methods, // @arg Object: { key: fn, ... }
                       delay) { // @arg String/Integer(= 0): base delay. 1 / "1" / "1s" / "1000ms"
                                ...
                                // @help: String#stream
//{@debug
    mm.allow("methods", methods, "Object/undefined");
//}@debug
...
//{@debug
    mm.allow("callback", callback, "Function/undefined");
    mm.allow("wait",     wait,     "Integer/undefined");
    mm.allow("unit",     unit,     "Integer/undefined");
...
function mm_url(url) { // @arg URLObject/URLString(= ""): "https://..."
                       ...
                       // @help: mm.url
//{@debug
    mm.allow("url", url, "Object/String/undefined");
//}@debug
